...
const { removeBackground } = require("../services/removeBgWorkerPool");
...
function createAssetsRouter({ pool }) {
  ...
  // CPU 密集计算（k-means + flood-fill + 羽化）在 worker_threads 执行，不阻塞主事件循环
